...
import {  GET_RESUME_TEMP, GET_WEBSITE_TEMP } from "../../constants/apis.js";
...
function SelectWebsiteTemplateListing({ activeTab ,setIsChooseTempModalOpen, setIsSelectResumeModalOpen}) {
  ...
  const apiCalling = async () => {
    try {
      const res = await axios.get(`/api${GET_WEBSITE_TEMP}`);
      console.log(res?.data?.data);

      const { _id,websiteTemplateName } = res?.data?.data;
